...
class AboutTuples(Koan):
    ...
    def test_tuples_can_only_be_changed_through_replacement(self):
        ...
        self.assertEqual(tuple([1,2,5,"boom"]), count_of_three)
    ...
    def test_tuple_constructor_can_be_surprising(self):
        self.assertEqual(tuple(['S','u','r','p','r','i','s','e','!']), tuple("Surprise!"))
    ...
    def test_tuples_can_be_embedded(self):
        ...
        self.assertEqual(tuple(['Area 51', (37, 14, 6, 'N'), (115, 48, 40, 'W')]), place)
